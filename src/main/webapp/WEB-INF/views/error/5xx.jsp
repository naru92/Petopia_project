...
<head>
  ...
  <body class="blue-bg">
      ...
      <div class="col-md-12">
      <div class="message">
      <h2>ìì²­íì  íì´ì§ë¥¼ ì°¾ì ì ììµëë¤.</h2>
      <p>ë°©ë¬¸ ìíìë íì´ì§ì ì£¼ìê° ìëª» ìë ¥ ëìê±°ë, ë³ê²½ í¹ì ì­ì ëì´ ìì²­íì  <p class="notExistPage">íì´ì§ë¥¼ ì°¾ì ìê° ììµëë¤.</p><br>
      </div>
      </div>
