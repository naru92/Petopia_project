...
<!-- CSS here -->
<link rel="stylesheet" href="/petopia/css/findPassword_style.css">
		...
		<div class="container">
			<div class="login-form">
				...
				<form action="/loginProcess" method="POST">
					...
					<div class="form-group">
						<input type="text" name="member_name" placeholder="이름"> <span
							class="input-icon"><i class="fa fa-user"></i></span>
					</div>
					<div class="form-group">
