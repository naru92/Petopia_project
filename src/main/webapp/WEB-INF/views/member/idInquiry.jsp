...
<!-- CSS here -->
<link rel="stylesheet" href="/petopia/css/idInquiry_style.css">
	...
	<main>
		<div class="container">
			<div class="login-form">
				...
				<form action="/help/findid" method="POST">
					<h3>아이디 찾기</h3>
                    <div class="info">
                    * 가입시 등록한 정보를 입력해 주세요.<br>
					...
					<div class="form-group">
						<input type="text" name="member_phoneNumber" placeholder="010-_ _ _ _-_ _ _ _"> 
...
$(document).ready(function() {
	...
	$('.confirm-btn').click(function(){
		...
		var member_phoneNumber = $('input[name=member_phoneNumber]').val();
		var member_email = $('input[name=member_email]').val(); //사용자의 이메일 입력값 
		...
		// ----- 휴대폰번호 확인 -----
		if (phoneJ.test(member_phoneNumber)) { 
			inval_Arr[1] = true; 
		} else { 
			inval_Arr[1] = false; 
			alert('휴대폰번호를 확인하세요.'); 
