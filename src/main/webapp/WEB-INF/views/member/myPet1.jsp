   ...
   <header>
    ...
    <main>
        <div class="main">
            ...
            <article class="one">   <!-- article 기능이 뭔지 (두개 다)? -->
                <article class="find1">
                    <div>
                        <section id="content3">
                        <div class="info">
                        ...
                        <div>
                            <!-- <div>어떤 반려동물과 함께 하시나요?</div> -->
                            <div>
                                <p class="pb0">어떤 반려동물과 함께 하시나요?</p>
                                <p><span id='choiceText'>&nbsp;</span></p>
                                <p>이름 *</p>
                                <p>성별 *</p>
                                <p>나이 *</p>
                                <p>생년월일</p>
                            ...
                            <div>
                                ...
                                <div style='width:300px'>
                                    ...
                                    <input type='text' id='txtKind' style='width:250px'></input>
                                </div>
                        ...
                        <a href="welcome.html"><button class="join-btn">이전</button></a>   <a href="welcome.html"><button class="join-btn">다음</button></a>
                    </section>
                    </div>
                </article>
            </article>
